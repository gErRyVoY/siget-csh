...
*   **Comprobado Contra Producción**: los 5 tickets de Marketing existentes (#23, #41, #43, #46, #47) están todos sin asignar. Antes solo los superadmins (ids 1 y 3) podían asignarlos; ahora también **Haide Herrera** (2), **Mariam Monroy** (293), **David Ocampo** (294) y **Karla Gonzalez** (296). **Ariadna Tinoco** (295) queda fuera porque tiene `atiende_mkt = false`. Los 35 tickets que no son de Marketing no cambian de permisos.
