...
*   **A Quién Afecta, Comprobado en Producción**: de los 10 admins/superadmins activos, exactamente **dos** cumplen la condición — **Haide Herrera** (id 2, 18 asignaciones, todas de Marketing) y el usuario de pruebas `alumno.prueba1` (id 290, 15 asignaciones). Los otros ocho, y cualquier usuario de rol 1, siguen yendo a `/`. Ninguna subcategoría está compartida entre Marketing y otra categoría, así que no hay casos ambiguos.
